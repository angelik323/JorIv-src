<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="goToURL('ConsolidationList')"
    >
      <section>
...
// Logic view
import useConsolidationCreate from '@/views/fixed-assets/consolidation/v1/create/ConsolidationCreate'
