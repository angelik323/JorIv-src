...
//Logic
import ExchangeDifferenceRestatementDetail from '@/views/accounting/accounting-restatement/v2/detail/ExchangeDifferenceRestatementDetail'
...
const {
  ...
  //Navigate
  goToURL,
} = ExchangeDifferenceRestatementDetail()
</script>
