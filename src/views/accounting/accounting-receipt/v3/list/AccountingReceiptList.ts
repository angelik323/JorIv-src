...
const useAccountingReceiptList = () => {
  ...
  const {
    ...
    voucher_statuses_v2,
    anullment_voucher_statuses,
    voucher_authorization_statuses,
  ...
  const tableProps = ref<IBaseTableProps<IAccountingReceiptItem>>({
    title: 'Listado comprobantes contables',
    loading: false,
    columns: [
      {
        name: 'id',
      ...
      },
      {
        ...
        align: 'left',
        field: (row) =>
          `${useUtils().formatDate(row.registration_date, 'YYYY-MM')}`,
        sortable: true,
      },
      {
        name: 'business',
      ...
      },
      {
        ...
        align: 'left',
        field: (row) =>
          `${row.business_trust.account?.cost_center_structure?.code ?? ''} - ${
            row.business_trust.account?.cost_center_structure?.purpose ?? ''
          }`,
        sortable: true,
      },
      {
        ...
        align: 'left',
        field: (row) => `${row.receipt_type.code} - ${row.receipt_type.name}`,
        sortable: true,
      },
      {
        name: 'consecutive',
      ...
      },
      {
        ...
        align: 'left',
        field: (row) => `${row.authorization_status?.id}`,
        sortable: true,
      },
      {
        name: 'actions',
  ...
  const filterConfig = ref<IFieldFilters[]>([
    ...
    },
    {
      ...
      value: null,
      class: 'col-12 col-md-4',
      options: voucher_authorization_statuses,
      disable: false,
      clean_value: true,
      placeholder: 'Todos',
      hide: true,
    },
    {
      ...
      value: null,
      class: 'col-12 col-md-4',
      options: anullment_voucher_statuses,
      disable: false,
      clean_value: true,
      placeholder: 'Todos',
      hide: true,
