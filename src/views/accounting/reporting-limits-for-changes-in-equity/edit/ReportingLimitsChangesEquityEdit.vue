      ...
      <section class="q-my-md">
        ...
        <div>
          <ReportingLimitsChangesInEquityForm
            ...
            :action="'edit'"
            :business="businessFromList"
            :account-structure="accountStructureFromList"
...
import useReportingLimitsForChangesInEquityEdit from './ReportingLimitsChangesEquityEdit'
...
const {
  ...
  onRowUpdated,
} = useReportingLimitsForChangesInEquityEdit()
</script>
