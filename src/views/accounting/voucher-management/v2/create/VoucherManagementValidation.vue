...
import ValidationForm from '@/components/Forms/Accounting/VoucherManagement/ValidationForm/ValidationForm.vue'
import GenericInputComponent from '@/components/common/GenericInput/GenericInputComponent.vue'
import imgButtonHeaderTable from '@/assets/images/excel.svg'

// Logic view
import useVoucherManagementValidation from '@/views/accounting/voucher-management/v2/create/VoucherManagementValidation'
...
const {
  ...
  goToURL,
  onSubmit,
} = useVoucherManagementValidation()
</script>
