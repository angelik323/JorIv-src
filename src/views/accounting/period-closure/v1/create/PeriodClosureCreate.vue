<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="$router.push({ name: 'PeriodClosureList' })"
    >
            ...
            >
              <div class="row justify-between items-center q-mb-md">
                <p class="text-subtitle1 text-weight-bold q-mb-none">
                  Informe de procesos pendientes
                </p>
...
import PeriodClosureForm from '@/components/Forms/Accounting/PeriodClosure/PeriodClosureForm.vue'
import imgButtonHeaderTable from '@/assets/images/excel.svg'
import usePeriodClosureCreate from './PeriodClosureCreate'
