<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      @to="goToURL('PeriodClosureParameterCreate')"
    >
        ...
        >
          <template #actions="{ row }">
            ...
            <Button
              ...
              tooltip="Ver"
              @click="
                goToURL('PeriodClosureParameterView', {
                  id: row.id,
                })
              "
            />
            ...
            <Button
              ...
              tooltip="Editar"
              @click="
                goToURL('PeriodClosureParameterEdit', {
                  id: row.id,
                })
              "
            />
...
// Logic view
import usePeriodClosureParameterList from '@/views/accounting/period-closure-parameter/v2/list/PeriodClosureParameterList'
