...
import usePeriodClosureParameterCreate from '@/views/accounting/period-closure-parameter/v1/create/PeriodClosureParameterCreate'
...
const {
  ...
  periodClosureParameterForm,
  onSubmit,
} = usePeriodClosureParameterCreate()
</script>
