...
import useQuarterlyBalanceCreate from './QuarterlyBalanceCreate'
import { ref } from 'vue'
import { OpeningRecordFormExpose } from '@/interfaces/customs'
import QuarterlyBalanceForm from '@/components/Forms/Accounting/AccoutingReport/QuarterlyBalance/QuarterlyBalanceForm.vue'
...
const {
  ...
  updatePerPage,
  updatePage,
} = useQuarterlyBalanceCreate(openingRecordForm)
</script>
