            ...
            <div v-if="activeTab === 'preview'" class="q-pa-md">
              ...
              >
                <template #custom-bottom-row>
                  <q-tr>
                    <q-td
                      :colspan="tableProps.columns.length - 3"
...
import useDiaryBookCreate from './DiaryBookCreate'
import { ref } from 'vue'
import { OpeningRecordFormExpose } from '@/interfaces/customs'
import DiaryBookForm from '@/components/Forms/Accounting/AccoutingReport/DiaryBook/DiaryBookForm.vue'
...
const {
  ...
  updatePerPage,
  updatePage,
} = useDiaryBookCreate(openingRecordForm)
</script>
