...
import useDailyBalanceCreate from './DailyBalanceCreate'
import { ref } from 'vue'
import { OpeningRecordFormExpose } from '@/interfaces/customs'
import DailyBalanceForm from '@/components/Forms/Accounting/AccoutingReport/DailyBalance/DailyBalanceForm.vue'
...
const {
  ...
  updatePerPage,
  updatePage,
} = useDailyBalanceCreate(openingRecordForm)
</script>
