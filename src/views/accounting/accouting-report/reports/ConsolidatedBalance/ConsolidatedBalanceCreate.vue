...
import useAccoutingReportCreate from './ConsolidatedBalanceCreate'
import { ref } from 'vue'
import { OpeningRecordFormExpose } from '@/interfaces/customs'
import ConsolidatedBalanceForm from '@/components/Forms/Accounting/AccoutingReport/ConsolidatedBalance/ConsolidatedBalanceForm.vue'
...
const {
  ...
  updatePerPage,
  updatePage,
} = useAccoutingReportCreate(openingRecordForm)
</script>
