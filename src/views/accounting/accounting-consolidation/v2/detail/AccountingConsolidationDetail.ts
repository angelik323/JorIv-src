...
const useAccountingConsolidationDetail = () => {
  ...
  const headerProperties = {
    title: 'Ver novedades del proceso',
    breadcrumbs: [
      ...headerProps.value.breadcrumbs,
      {
        label: 'Ver',
        route: 'AccountingConsolidationDetail',
      },
      {
  ...
  onMounted(async () => {
    ...
    await _getUpdateInfo(Number(routeParams))
...
export default useAccountingConsolidationDetail
