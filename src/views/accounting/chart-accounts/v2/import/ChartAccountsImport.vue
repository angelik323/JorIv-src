        ...
        <div v-else>
          ...
          >
            ...
            <template #actions="{ row }">
              <!-- Descargar -->
              <Button
                v-if="row.status_id === 30 && !invalidImport"
          ...
          <div class="row justify-end q-gutter-md mt-2">
            <Button
              :label="
                tableProps.rows.length && tableProps.rows[0].status_id === 30
                  ? 'Cancelar'
                  : 'Cargar'
              "
              :size="'md'"
...
// composables
import useChartAccountsImport from '@/views/accounting/chart-accounts/v2/import/ChartAccountsImport'
