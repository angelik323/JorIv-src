<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="$router.push({ name: 'PortfolioClassificationList' })"
    >
      <section>
...
// Logic view
import usePortfolioClassificationEdit from '@/views/settlement-commissions/portfolio-classification/v1/edit/PortfolioClassificationEdit'
...
const {
  ...
  onSubmit,
} = usePortfolioClassificationEdit()
</script>
