...
export const useSupportDocumentNumberingResolutionsCreate = () => {
  ...
  const { _createSupportDocumentNumberingResolution } =
  ...
  const headerProps = {
    title: 'Crear resolución documento soporte',
    breadcrumbs: [
      ...
      {
        label: 'Crear',
        route: 'SupportDocumentNumberingResolutionsCreate',
      },
    ],
  }
  ...
  const handleSubmit = async () => {
    ...
    if (await _createSupportDocumentNumberingResolution(payload)) {
...
export default useSupportDocumentNumberingResolutionsCreate
