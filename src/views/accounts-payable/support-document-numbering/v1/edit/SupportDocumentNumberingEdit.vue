<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="goToURL('SupportDocumentNumberingList')"
    ></ContentComponent>
...
//Logic
import useSupportDocumentNumberingEdit from '@/views/accounts-payable/support-document-numbering/v1/edit/SupportDocumentNumberingEdit'
...
const {
  ...
  handleEdit,
  goToURL,
} = useSupportDocumentNumberingEdit()
</script>
