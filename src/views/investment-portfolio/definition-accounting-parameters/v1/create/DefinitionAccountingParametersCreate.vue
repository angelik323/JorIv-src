      ...
      <section class="q-my-md">
        ...
        <VCard>
          <template #content-card>
            <BasicDataForm ref="basicDataFormRef" :action="'create'" />
          </template>
        </VCard>
...
import useDefinitionAccountingParametersCreate from './DefinitionAccountingParametersCreate'
...
const {
  ...
  nextTab,
  onSubmit,
} = useDefinitionAccountingParametersCreate()
</script>
