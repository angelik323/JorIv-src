...
const useForeignExchangeBuyCreate = () => {
  ...
  const headerProps = {
    ...
    breadcrumbs: [
      ...
      { label: 'Crear', route: 'ForeignExchangeBuyCreate' },
    ],
  }
  ...
  const onSubmit = async () => {
    if (await validateForms()) {
      ...
      const base = foreignExchangeForm.value.getFormData()
      const payload = { ...base, type: 'BUY' as const }
...
export default useForeignExchangeBuyCreate
