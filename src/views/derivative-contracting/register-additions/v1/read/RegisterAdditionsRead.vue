            ...
            <section class="mx-4 mb-4">
              <div class="row justify-end q-gutter-md">
                ...
                <Button
                  ...
                  color="orange"
                  class="custom"
                  @click="goToURL('RegisterAdditionsList')"
                />
              </div>
            </section>
          </template>
...
// Logic view
import useRegisterAdditionRead from '@/views/derivative-contracting/register-additions/v1/read/RegisterAdditionsRead'
