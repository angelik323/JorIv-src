...
// Logic view
import useTypesContractingDocumentsCreate from '@/views/derivative-contracting/types-contracting-documents/v1/create/TypesContractingDocumentsCreate'
...
const {
  ...
  onSubmit,
  goToURL,
} = useTypesContractingDocumentsCreate()
</script>
