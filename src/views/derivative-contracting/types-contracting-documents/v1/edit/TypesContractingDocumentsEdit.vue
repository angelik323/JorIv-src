...
// Logic view
import useTypesContractingDocumentsEdit from '@/views/derivative-contracting/types-contracting-documents/v1/edit/TypesContractingDocumentsEdit'
...
const {
  ...
  onSubmit,
  goToURL,
} = useTypesContractingDocumentsEdit()
</script>
