<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      @to="goToURL('EquivalenceParametersCreate')"
    >
      <!-- :btn-label="
        validateRouter('Normative', 'EquivalenceParametersList', 'create')
...
// Logic view
import useEquivalenceParametersList from '@/views/normative/equivalence-parameters/v1/list/EquivalenceParametersList'
