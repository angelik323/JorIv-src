...
const useOpeningCertificateCreate = () => {
  ...
  const headerProperties = {
    title: 'Generación de certificados de apertura',
    breadcrumbs: [
  ...
  const onSubmit = async () => {
    ...
    const success = await _createGenerationCertificate('opening', payload)
    if (success) goToURL('OpeningGroupList')
...
export default useOpeningCertificateCreate
