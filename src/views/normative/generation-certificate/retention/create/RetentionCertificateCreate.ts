...
const useRetentionCertificateCreate = () => {
  ...
  const headerProperties = {
    title: 'Generación de certificados de retención',
    breadcrumbs: [
  ...
  const onSubmit = async () => {
    ...
    const success = await _createGenerationCertificate('retention', payload)
    if (success) goToURL('RetentionGroupList')
...
export default useRetentionCertificateCreate
