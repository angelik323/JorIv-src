<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      @to="goToURL('RetentionCertificateCreate', 2)"
    >
        ...
        >
          <template #actions="{ row }">
            ...
            <Button
              ...
              colorIcon="#f45100"
              :tooltip="'Ver'"
              @click="goToURL('RetentionDetailList', row.id)"
            />
...
// Logic view
import { useGenerationRetentionCertificateList } from '@/views/normative/generation-certificate/retention/list/group/RetentionGroupList'
