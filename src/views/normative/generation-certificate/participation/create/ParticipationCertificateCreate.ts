...
const useParticipationCertificateCreate = () => {
  ...
  const headerProperties = {
    title: 'Generación de certificados participación',
    breadcrumbs: [
  ...
  const onSubmit = async () => {
    ...
    const success = await _createGenerationCertificate('participation', payload)
    if (success) goToURL('ParticipationGroupList')
...
export default useParticipationCertificateCreate
