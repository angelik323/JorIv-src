...
export const useGenerationParticipationCertificateList = () => {
  const {
  ...
  const headerProperties = {
    title: 'Generación certificados participación',
    breadcrumbs: [
      ...headerPropsDefault.breadcrumbs,

      {
        label: 'Generación certificado participación',
        route: 'GenerationParticipationCertificateList',
      },
    ],
  }
  ...
  >({
    title: 'Listado de generación de certificados participación',
    loading: false,
    wrapCells: true,
    columns: [
      {
  ...
  const goToView = (row: IGenerationCertificateDetailListItem) => {
    ...
    _setRouterList('ParticipationGroupList')
    _setUrl(row.url)
  }
