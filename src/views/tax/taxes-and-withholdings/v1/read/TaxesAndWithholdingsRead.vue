        ...
        <Card>
          <template #content-card>
            <div class="q-px-xl q-pb-xl q-pt-lg">
              ...
              <ValiditiesForm
                v-if="tabActive === 'validities'"
                ref="validitiesFormRef"
                action="view"
                v-model:data="validities_form"
              />
            ...
            <section class="mx-4 mb-4">
              <div class="row justify-end q-gutter-md">
                ...
                <Button
                  ...
                  color="orange"
                  class="custom"
                  @click="goToURL('TaxesAndWithholdingsList')"
                />
              </div>
            </section>
          </template>
...
import ValiditiesForm from '@/components/Forms/Tax/TaxesAndWithholdings/v1/Validities/BasicData.vue'
...
// Logic
import useTaxesAndWithholdingsEdit from '@/views/tax/taxes-and-withholdings/v1/read/TaxesAndWithholdingsRead'
