        ...
        >
          ...
          <template #actions="{ row }">
            <Button
              ...
              colorIcon="#f45100"
              :tooltip="'Editar'"
              @click="goToURL('JurisdictionEdit', { id: row.id })"
            />
            <Button
              :label="''"
...
import useJurisdictionsList from '@/views/tax/jurisdictions/v1/list/JurisdictionList'
