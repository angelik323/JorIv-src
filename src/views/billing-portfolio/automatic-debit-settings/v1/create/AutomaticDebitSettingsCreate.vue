...
// Logic view
import useAutomaticDebitSettingsCreate from '@/views/billing-portfolio/automatic-debit-settings/v1/create/AutomaticDebitSettingsCreate'
...
const {
  ...
  onSubmit,
  goToURL,
} = useAutomaticDebitSettingsCreate()
</script>
