  ...
  <div class="q-mx-xl">
    ...
    >
      <section>
        ...
        <VCard v-if="supporting_documents_response">
...
// Logic view
import useSupportingDocumentsView from '@/views/billing-portfolio/supporting-documents/v1/view/SupportingDocumentsView'
