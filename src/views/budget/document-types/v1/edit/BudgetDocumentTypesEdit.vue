          ...
          <template #content-card>
            <div class="q-pa-lg">
              ...
              <BalanceValidationForm
                ...
                action="edit"
                :data="
                  documentTypeData?.budget_document_type_balance_validations
                "
              />
...
// Logic view
import useBudgetDocumentTypesEdit from '@/views/budget/document-types/v1/edit/BudgetDocumentTypesEdit'
