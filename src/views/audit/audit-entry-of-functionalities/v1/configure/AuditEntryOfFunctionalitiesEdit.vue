              ...
              <div v-for="submodule in row.submodule" :key="submodule.id">
                ...
                >
                  <template #header>
                    <q-item-section avatar>
                      <q-checkbox
                        v-model="submodule.is_confidential"
                        @update:model-value="
                  ...
                  <div v-for="action in submodule.actions">
                    <q-expansion-item expand-separator hide-expand-icon>
                      <template #header>
                        <q-item-section avatar>
                          <q-checkbox
                            v-model="action.is_confidential"
                            @update:model-value="
                        ...
                        <q-item-section>
                          <q-item-label caption>Funcionalidad</q-item-label>
...
import useAuditEntryOfFunctionalitiesEdit from '@/views/audit/audit-entry-of-functionalities/v1/configure/AuditEntryOfFunctionalitiesEdit'
...
const {
  ...
  toggleSubmodule,
  toggleAction,
} = useAuditEntryOfFunctionalitiesEdit()
</script>
