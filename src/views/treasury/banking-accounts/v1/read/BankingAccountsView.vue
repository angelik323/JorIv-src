...
import InformationForm from '@/components/Forms/Treasury/BankingAccounts/Information/InformationForm.vue'
import PerformanceForm from '@/components/Forms/Treasury/BankingAccounts/Performance/PerformanceForm.vue'
import RestatementForm from '@/components/Forms/Treasury/BankingAccounts/Restatement/RestatementForm.vue'
import Card from '@/components/common/VCard/VCard.vue'
import Button from '@/components/common/Button/Button.vue'

// Logic view
import useBankingAccountsView from '@/views/treasury/banking-accounts/v1/read/BankingAccountsView'
