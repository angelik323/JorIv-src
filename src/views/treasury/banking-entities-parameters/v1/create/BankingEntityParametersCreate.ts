...
const useBankingEntityParametersCreate = () => {
  ...
  const headerProps = {
    title: 'Crear parámetro entidades bancarias',
    breadcrumbs: [
      {
        label: 'Inicio',
        route: 'HomeView',
      ...
      },
      {
       ...
       {
        label: 'Crear',
        route: 'BankingEntityParametersCreate',
      },
    ],
  }
  ...
  const onSubmit = async () => {
    ...
    const success = await _createBankingEntitiesAccountingParametersCommissions(payload as ICreateBankingEntitiesAccountingParametersCommissions)
    if (success) {
...
export default useBankingEntityParametersCreate