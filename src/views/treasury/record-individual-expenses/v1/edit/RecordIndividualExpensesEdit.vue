<template>
  <div class="q-px-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="handlerGoTo('RecordIndividualExpensesList')"
    >
    </ContentComponent>
...
import useRecordIndividualExpensesEdit from '@/views/treasury/record-individual-expenses/v1/edit/RecordIndividualExpensesEdit'
...
const {
  ...
  onSubmit,
  handlerGoTo,
} = useRecordIndividualExpensesEdit()
</script>
