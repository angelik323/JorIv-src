        ...
        <VCard>
          <template #content-card>
            <section class="q-pa-lg">
              <InformationForm action="unFreeze" />
...
// Logic view
import useUnFreezeResourcesCreate from '@/views/fics/freeze-resources/v1/create/UnFreezeResourcesCreate'
