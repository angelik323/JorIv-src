              ...
              <div class="row q-col-gutter-x-lg q-col-gutter-y-sm">
                <div class="col-12 col-md-12">
                  <GenericSelectorComponent
                    ...
                    "
                    :manual_option="operation_columns"
                    map_options
                  />
...
// Logic view
import useBulkUploadTemplatesEdit from '@/views/fics/bulk-upload-templates/v1/edit/BulkUploadTemplatesEdit'
