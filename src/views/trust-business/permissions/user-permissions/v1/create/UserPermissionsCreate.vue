<template>
  <div class="q-mx-xl">
    <ContentComponent
      ...
      show-back-btn
      @on-back="$router.push({ name: 'UserPermissionsList' })"
    >
...
// Logic view
import useUserPermissionsCreate from '@/views/trust-business/permissions/user-permissions/v1/create/UserPermissionsCreate'
