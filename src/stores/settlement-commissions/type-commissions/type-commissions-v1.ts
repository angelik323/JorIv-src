...
export const useTypeCommissionsStoreV1 = defineStore(
  'type-commissions-store-v1',
  {
    state: () => ({
      version: 'v1',
      type_commissions_list: [] as ITypeCommissionsList[],
      type_commissions_response: null as ITypeCommissionsResponse | null,
    ...
    actions: {
      ...
      async _createTypeCommissions(
        data: Partial<ITypeCommissionsInformationForm>
      ) {
        let success = false
