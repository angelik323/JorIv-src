      ...
      <q-item-section>
        <div class="column">
          ...
          <span class="text-subtitle1 text-grey-14">
            Haz click sobre Tipo de registro para desplegar la tabla
          </span>
        </div>
      </q-item-section>
      <q-item-section side>
        <Button
          ...
          :tooltip="
            canCreateRecordType
              ? 'Añadir tipo de registro'
              : 'Primero debes seleccionar una definición de formato'
          "
          :stop-propagation="true"
          @click="handleOptions('create')"
          :disabled="!canCreateRecordType"
        />
      </q-item-section>
    </template>
    <TableList
      ref="tableRecordTypeList"
...
import useRecordTypeList from './RecordTypeList'
import AlertModalComponent from '@/components/common/AlertModal/AlertModalComponent.vue'
import RecordTypeForm from '@/components/Forms/Treasury/BankStuctures/RecordType/RecordTypeForm.vue'
