...
import { IDocumentsRegister } from '@/interfaces/customs/fixed-assets/v1/Register'
...
// logic
import useDocumentsForm from '@/components/Forms/FixedAssets/Register/DocumentsForm/DocumentsForm'

const props = withDefaults(
  defineProps<{
    action: ActionType
    data?: IDocumentsRegister[] | null
    assetReference?: string
    initialDocuments?: IDocumentsRegister[] | null
  }>(),
  {}
)

const emit = defineEmits<{
  'update:models': [data: IDocumentsRegister[]]
}>()
