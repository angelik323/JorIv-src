...
import { ILegalClientManager } from '@/interfaces/customs/clients/Clients'

// Composables
import { useUtils } from '@/composables'

// Logic form
import useManagerForm from '@/components/Forms/Clients/v2/LegalPerson/Manager/ManagerForm'
