import { IManagerPEPForm } from '@/interfaces/customs/Clients'
import { onMounted, ref, watch } from 'vue'
import { storeToRefs } from 'pinia'
import { useClientsStore } from '@/stores'

export const usePEPForm = (props: any) => {
  const { data_manager_pep_form } = storeToRefs(useClientsStore('v1'))
  const { _setDataManagerPEPForm } = useClientsStore('v1')
