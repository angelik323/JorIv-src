...
import TributaryForm from './Tributary/TributaryForm.vue'
import { useShareholderGenerator } from './ShareholderGenerator'

const props = withDefaults(
  defineProps<{
    isOpen: boolean
    rules?: ValidationRule[]
    itemToEdit?: IShareholder
    required?: boolean
...
const {
  ...
  onSubmit,
  closeModal,
} = useShareholderGenerator(props, emit)
</script>
