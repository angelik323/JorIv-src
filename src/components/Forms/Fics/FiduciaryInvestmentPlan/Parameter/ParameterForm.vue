    ...
    <section>
      <div class="row q-col-gutter-x-lg q-col-gutter-y-sm">
        ...
        >
          ...
          />
          <div v-else class="text-black-90">
            <p class="text-weight-bold no-margin ellipsis">Linea de negocio</p>
            <p class="text-weight-medium no-margin">
              {{
...
// logic view
import useParameterForm from '@/components/Forms/Fics/FiduciaryInvestmentPlan/Parameter/ParameterForm'
