...
import useGeneralResultsForm from '@/components/Forms/Accounting/AccoutingReport/GeneralResults/GeneralResultsForm'
...
} = useGeneralResultsForm(props, emits)
</script>
