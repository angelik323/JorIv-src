            ...
            <template #actions="{ row }">
              ...
              <Button
                v-if="
                  ...
                  homologationProcessLogStatusID.HOMOLOGATION_FAILED
                "
...
import useRevertHomologationForm from '@/components/Forms/Accounting/HomologationProcess/RevertHomologation/RevertHomologationForm'
