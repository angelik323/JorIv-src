        ...
        <q-form ref="informationForm" class="q-px-lg q-pt-lg">
          <section>
            <div class="row q-col-gutter-x-lg q-col-gutter-y-sm items-end">
              ...
              <div class="col-12 col-md-3">
                <GenericSelectorComponent
                  label="Deshacer homologación D/M"
                  map_options
                  required
                  placeholder="Seleccione"
                  ...
                  :rules="[
                    (v: string) =>
                      useRules().is_required(v, 'El campo deshacer homologación D/M es requerido'),
                  ]"
              ...
              <div class="col-12 col-md-3">
                <GenericDateInputComponent
                  ...
                  :rules="[
                    (v: string) =>
                      useRules().is_required(v, 'El campo deshacer a fecha es requerido'),
                  ]"
        ...
        <section class="q-ma-lg">
          <div class="row justify-end q-gutter-md">
            ...
            <Button
              :outline="false"
              :class-custom="'custom q-mt-md'"
              label="Deshacer homologación"
              size="md"
              color="orange"
              @click="revertBulkHomologation"
            />
          </div>
        </section>
      </template>
...
import useRevertBulkHomologationForm from '@/components/Forms/Accounting/HomologationProcess/RevertBulkHomologation/RevertBulkHomologationForm'
