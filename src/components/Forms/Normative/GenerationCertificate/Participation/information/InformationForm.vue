...
// logic
import useInformationForm from '@/components/Forms/Normative/GenerationCertificate/Opening/Information/InformationForm'
...
const { models, formElementRef, personTypeOptions, third_parties } =
