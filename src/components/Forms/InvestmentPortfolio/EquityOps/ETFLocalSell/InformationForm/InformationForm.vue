    ...
    <section aria-label="Sección de formulario de datos básicos">
      ...
      >
        ...
        >
          ...
          <div class="col-12 col-md-3 text-black-90">
            <p class="text-weight-bold no-margin">Cantidad unidades a vender</p>
            <p class="text-weight-medium no-margin">
          ...
          <div class="col-12 col-md-3 text-black-90">
            <p class="text-weight-bold no-margin">Valor unidad</p>
            <p class="text-weight-medium no-margin">
              {{
...
import useInformationForm from '@/components/Forms/InvestmentPortfolio/EquityOps/ETFLocalSell/InformationForm/InformationForm'
