<template>
      ...
      <div class="row q-col-gutter-x-lg q-col-gutter-y-sm">
        ...
        <div class="col-12 col-md-3">
          ...
          <div v-else class="text-black-90">
            ...
            <p
              ...
              aria-labelledby="lbl-document_emitter"
            >
        ...
        <div class="col-12 col-md-3">
          <GenericDateInputComponent
            ...
            required
            :rules="[]"
            @update:modelValue="formData.operation_date = $event"
          />
          <div class="text-black-90" v-else>
        ...
        <div class="col-12 col-md-3">
          <GenericSelectorComponent
            v-if="!isView"
            :default_value="String(formData.operation_code)"
            label="Código de operación"
            placeholder="Seleccione"
            :manual_option="operationCode"
            :disabled="isEdit"
            map_options
            required
            auto_complete
        ...
        >
          <div class="col-12 col-md-3">
            <GenericSelectorComponent
              ...
              label="Clase acción"
              placeholder="Seleccione"
              :manual_option="classActions"
              map_options
              required
              auto_complete
              :rules="[
              (v: string) => useRules().is_required(v, 'La clase acción es requerida'),
            ]"
          ...
          <div class="col-12 col-md-3">
            <GenericInputComponent
              ...
              required
              :rules="[
              (v: string) => useRules().is_required(v, 'El Id Unidad / Acción es requerido'),
              (v: string) => useRules().max_length(v, 20),
              (v: string) => useRules().only_letters(v),
            ]"
              @update:modelValue="formData.unit_id_action = $event"
            />
            <div class="text-black-90" v-else>
          ...
          <div class="col-12 col-md-3">
            <GenericInputComponent
              ...
              required
              :rules="[
              (v: string) => useRules().is_required(v, 'La cantidad de acciones es requerida'),
              (v: string) => useRules().only_number_with_max_integers_and_decimals(v, 15, 6),
            ]"
              @update:modelValue="formData.number_of_shares = $event"
            />
            <div class="text-black-90" v-else>
          ...
          <div class="col-12 col-md-3">
            <GenericSelectorComponent
              ...
              placeholder="Seleccione"
              :manual_option="dividendTypes"
              map_options
              required
              auto_complete
              :rules="[
              (v: string) => useRules().is_required(v, 'El tipo de dividendo es requerido'),
            ]"
              @update:modelValue="formData.dividend_type = $event"
            />
            <div class="text-black-90" v-else>
          ...
          <div class="col-12 col-md-3">
            <GenericDateInputComponent
              ...
              :disabled="isEdit"
              :rules="[
              (val: string) => useRules().date_after_or_equal_to_specific_date(val, formData.operation_date),
          ...
          <div class="col-12 col-md-3">
            <GenericDateInputComponent
              ...
              :required="isExDividend"
              :rules="
    isExDividend
      ? [
          (val: string) => useRules().date_after_or_equal_to_specific_date(val, formData.dividend_record_date),
          (val: string) => useRules().date_after_or_equal_to_specific_date(val, formData.due_date),
  ...
  "
          ...
          <div class="col-12 col-md-3">
            <GenericSelectorComponent
              v-if="!isView"
              :default_value="String(formData.currency_id)"
              label="Moneda origen"
              placeholder="Seleccione"
              :manual_option="currency"
              map_options
              required
              auto_complete
              :rules="[
          ...
          <div class="col-12 col-md-3">
            <GenericInputComponent
              ...
              (v: string) => useRules().is_required(v, 'El valor dividendo es requerido'),
            ]"
          ...
          <div class="col-12 col-md-3">
            <GenericInputComponent
              ...
              label="Valor dividendo despues de impuesto"
              placeholder="Inserte"
              type="text"
              required
              :rules="[
              (v: string) => useRules().is_required(v, 'El valor dividendo despues de impuesto es requerido'),
              (v: string) => useRules().only_number_with_max_integers_and_decimals(v, 15, 2),
            ]"
            ...
            <div class="text-black-90" v-else>
              <p
                ...
                class="text-weight-bold no-margin"
              >
                Valor dividendo después de impuesto
              </p>
              <p
                class="text-weight-medium no-margin"
          ...
          <div class="col-12 col-md-3">
            <GenericInputComponent
              ...
              label="Valor exigibilidad"
              placeholder="Inserte"
              type="text"
              required
              :rules="[
              (v: string) => useRules().is_required(v, 'El valor exigibilidad es requerido'),
              (v: string) => useRules().only_number_with_max_integers_and_decimals(v, 15, 2),
            ]"
        ...
        >
          ...
          <div class="col-12 col-md-3 text-black-90">
            ...
            >
              {{ formData.history_issuer_dividend?.created_at || '-' }}
            </p>
          </div>
          ...
          <div class="col-12 col-md-3 text-black-90">
            ...
            >
              {{ formData.history_issuer_dividend?.creator_data || '-' }}
            </p>
          </div>
          ...
          <div class="col-12 col-md-3 text-black-90">
            ...
            >
              {{ formData.history_issuer_dividend?.updated_at || '-' }}
            </p>
          </div>
          ...
          <div class="col-12 col-md-3 text-black-90">
            ...
            >
              {{ formData.history_issuer_dividend?.updated_data || '-' }}
            </p>
          </div>
