      ...
      >
        <div class="col-xs-12 col-sm-12 col-md-3">
          <GenericSelector
            ...
            auto_complete
            :disabled="!is_required_fields_derivates"
            :required="is_required_fields_derivates"
            :rules="is_required_fields_derivates ? [
              (v: string) =>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3">
          ...
          <RadioYesNo
            ...
            :isDisabled="
              ['view'].includes(action) || !is_required_fields_derivates
            "
          />
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3">
          ...
          <div v-else class="text-black-90">
            ...
            <p class="text-weight-medium no-margin">
              {{ models.cost_center_id ?? 'No registrado' }}
            </p>
          </div>
        </div>
...
import { nature_options, target_options } from '@/constants/resources'
import { ActionType } from '@/interfaces/global'
import { IDefinitionAccountingParametersDerivates } from '@/interfaces/customs'
import useDerivateForm from './DerivateForm'
