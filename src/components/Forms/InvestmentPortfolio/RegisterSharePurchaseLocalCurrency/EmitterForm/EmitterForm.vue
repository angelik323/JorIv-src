      ...
      <div class="row q-col-gutter-x-lg q-col-gutter-y-sm">
        ...
        <div class="col-12 col-md-3">
          <GenericSelectorComponent
            ...
            map_options
            required
            :manual_option="selectOptions.currencyLocal"
            :rules="[
        ...
        <div class="col-12 col-md-3">
          <GenericInputComponent
            ...
            required
            :rules="[
              (val: string) => useRules().is_required(val, 'El valor de la moneda es requerido'),
            ]"
            @update:model-value="formData.value_currency = $event"
          />
        </div>

        <div class="col-12 col-md-3" v-if="formData.has_commision">
          <RadioYesNo
            class="q-mt-none"
            has-title
            v-model="formData.commission_base"
            title="Base comisión*"
            :is-disabled="!formData.has_commision"
            :titleRadioTrue="'Porcentaje'"
        ...
        <div class="col-12 col-md-3" v-if="formData.has_commision">
          <GenericInputComponent
            ...
            type="text"
            required
            :disabled="!formData.has_commision"
            :rules="[
