...
import useRepoWarrantyForm from './WarrantyForm'
...
const props = defineProps<{
  action: ActionType
  position: 'Activo' | 'Pasivo'
  data?: IWarrantyFormData
}>()

const { formData, warrantyFormRef, selectOptions, resetForm } =
  useRepoWarrantyForm(props)
