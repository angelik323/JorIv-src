...
import { ITitlesReceived, ITtvOption, IOptions } from '@/interfaces/customs'
...
const useTitlesReceivedForm = (props: {
  action: ActionType
  data?: ITitlesReceived
}) => {
  ...
  const formData = ref<ITitlesReceived>({
...
export default useTitlesReceivedForm
