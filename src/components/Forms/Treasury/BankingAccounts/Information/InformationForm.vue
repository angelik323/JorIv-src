        ...
        <div class="row q-col-gutter-sm mt-1">
          ...
          >
            <p
              ...
              "
            >
              {{ ['view'].includes(action) ? 'Nombre' : 'Nombre de negocio*' }}
            </p>
          ...
          >
            ...
            <GenericInput
              ...
              :rules="[
                (val: string) =>
                  useRules().is_required(val, 'El nombre es requerido'),
            ...
            <GenericSelectorComponent
              ...
              :rules="[
                (val: string) =>
                  useRules().is_required(
                    val,
                    'El titularo responsable es requerido'
                  ),
              ]"
          ...
          >
            <p
              ...
              "
            >
              Fecha de cierre de conciliación
            </p>
          ...
          >
            <p
              ...
              "
            >
              Fecha de cierre de tesorería
            </p>

            <GenericDateInputComponent
              v-if="['create', 'edit'].includes(action)"
              :default_value="models.treasury_closing_date"
              :required="false"
              :rules="[]"
              @update:modelValue="models.treasury_closing_date = $event"
            />
            <p v-else class="mb-0 text-grey-9">
              {{
        ...
        <div class="row q-col-gutter-sm mt-1">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6">
            ...
            <GenericSelectorComponent
              v-if="['create', 'edit'].includes(action)"
              :disabled="
                models.business_id === 0 || models.business_id === null
              "
            ...
            <p v-else class="mb-0 text-grey-9">
              {{
                `${models.gmf_business_accounting_account_code ?? ''} - ${
                  models.gmf_business_accounting_account_name ?? ''
                }`
              }}
              -
            </p>
        ...
        <div class="row q-col-gutter-sm mt-1">
          ...
          >
            ...
            <CurrencyInput
              ...
              :rules="[
                (val: string) =>
                  useRules().is_required(val, 'El rango superior es requerido'),
...
import useInformationForm from '@/components/Forms/Treasury/BankingAccounts/Information/InformationForm'
